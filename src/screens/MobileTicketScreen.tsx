...
const styles = StyleSheet.create({
  ...
  infoLabel: {width: 120, fontSize: 13, fontWeight: '800'},
  ...
  gridLabel: {width: 90, fontSize: 12, fontWeight: '800'},
  ...
  colCode: {width: 70}, colDesc: {flex: 1}, colQty: {width: 50, textAlign: 'right'}, colUnit: {width: 40, textAlign: 'center'}, colPrice: {width: 50, textAlign: 'right'}, colAmount: {width: 90, textAlign: 'right'},
  thText: {fontSize: 12, fontWeight: '800'}, tdText: {fontSize: 12, fontWeight: '500'},
  totalsBlock: {marginTop: 12, alignItems: 'flex-end'},
  totalRow: {flexDirection: 'row', paddingVertical: 8, width: 200},
  totalLabel: {flex: 1, fontSize: 14, fontWeight: '800', textAlign: 'right', paddingRight: 16},
  totalValue: {width: 100, fontSize: 14, fontWeight: '500'},
  timeGrid: {flexDirection: 'row', flexWrap: 'wrap'},
  timeCell: {width: '33.33%', flexDirection: 'row', paddingVertical: 6},
  timeLabel: {fontSize: 12, fontWeight: '800', width: 90},
  timeValue: {fontSize: 12, fontWeight: '500'},
  signatureSection: {paddingHorizontal: 20, paddingVertical: 24, alignItems: 'center'},
  signatureBox: {width: '60%', maxWidth: 500, height: 100, borderRadius: 8, borderWidth: 1, marginBottom: 24},
  actionRow: {flexDirection: 'row', gap: 16, width: '60%', maxWidth: 500},
